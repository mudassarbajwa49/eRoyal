...
export default function ComplaintsLayout() {
    ...
    return (
        ...
        >
            <Stack.Screen name="create" options={{ title: 'Submit Complaint', headerLeft: BackButton }} />
            <Stack.Screen name="[id]" options={{ title: 'Complaint Details', headerLeft: BackButton }} />
        </Stack>
    );
}
